...
import {
  ...
  v,
  w
} from "./chunk-GE7JRJOL.js";
import "./chunk-RV6ZLP5Q.js";
import {
  V as V2,
  l as l4
...
import "./chunk-6A36XX2Q.js";
import "./chunk-NCLK6YLE.js";
import {
  r as r3
  ...
  async _generateSymbolPreviewForInfo(e10, t5, s8) {
    try {
      ...
      if (this._scaleDrivenSizeVariable && s8?.applyScaleDrivenSize) {
        const { getSize: t6 } = await import("./visualVariableUtils-YHLE7DFA.js");
...
var p7 = class extends O {
  ...
  loadDependencies() {
    return c2({ carousel: () => import("./calcite-carousel-3LE7TXBY.js"), "carousel-item": () => import("./calcite-carousel-item-FEDQSBWL.js") });
  }
  render() {
