...
function Z(e, t, i, s3, n5) {
  const a3 = se(e, t, n5);
  let _ = K(e, a3.first, i, s3, n5), r = 1, h2 = 0, o2 = 0;
  do {
    if (r++, a3.first *= 0.5, a3.first < 50 * t.getTolerance(0)) return _;
    a3.second *= 2, o2 = K(e, a3.first, i, s3, n5), h2 = Math.abs(o2 - _), _ = o2;
  } while (Math.abs(_) > 1 && h2 > 1e-8 * Math.abs(_) && (a3.second < 65e3 && r < 8 || r < 4));
  return o2;
}
function K(e, t, i, s3, n5) {
  ...
  let c = 0;
  return c += W(_, m2, i, n5), c += W(_, l, i, n5), c += W(_, p, i, n5), c;
}
function W(e, t, i, s3) {
...
var ge = class {
  ...
  executeClippedPolygonGeodeticArea(e, t, i) {
    ...
    try {
      ...
      let B2, H2;
      for (O = e.getPathStart(0), v2 = 0; v2 < I2; v2++, O = D) for (D = e.getPathEnd(v2), h2.queryPoint2D(D - 1 << 1, J2), o2.queryPoint2D(D - 1 << 1, k), Math.abs(k.y) > q2 && (k.y = B(q2, k.y)), G = O; G < D; G++, J2.assign(Y), k.assign(F)) {
...
//# sourceMappingURL=OperatorGeodeticArea-R3HUK75L.js.map
