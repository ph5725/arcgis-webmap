...
var l2 = class extends l {
  ...
  async insertGap(e, t2, r2) {
    const [{ insertGap: s }, { default: n }] = await Promise.all([import("./insertGap-2US6BPWF.js"), import("./InsertGapParameters-7NYBDPP4.js")]), l3 = new n({ object: e, firstUnit: t2, numUnits: r2 });
    c(this.featureServiceUrl, this.gdbVersion || null) ? (l3.sessionId = t, await i(this.featureServiceUrl, this.gdbVersion, true)) : l3.sessionId = null, l3.gdbVersion = this.gdbVersion;
    const u2 = c2(this.featureServiceUrl, null, this.gdbVersion, false), c3 = await s(this.networkServiceUrl, l3);
    u2.resolve({ edits: null, addedFeatures: [], updatedFeatures: [], deletedFeatures: [], addedAttachments: [], updatedAttachments: [], deletedAttachments: [], exceededTransferLimit: c3.exceededTransferLimit, historicMoment: c3.moment, editedFeatures: c3.serviceEdits || void 0 });
  }
  async reset(e) {
    const [{ reset: t2 }, { default: r2 }] = await Promise.all([import("./reset-KEEM67DV.js"), import("./ResetParameters-BBCM2I2W.js")]), s = new r2({ objects: e });
    c(this.featureServiceUrl, this.gdbVersion || null) ? (s.sessionId = t, await i(this.featureServiceUrl, this.gdbVersion, true)) : s.sessionId = null, s.gdbVersion = this.gdbVersion;
    const n = c2(this.featureServiceUrl, null, this.gdbVersion, false), l3 = await t2(this.networkServiceUrl, s);
    n.resolve({ edits: null, addedFeatures: [], updatedFeatures: [], deletedFeatures: [], addedAttachments: [], updatedAttachments: [], deletedAttachments: [], exceededTransferLimit: l3.exceededTransferLimit, historicMoment: l3.moment, editedFeatures: l3.serviceEdits || void 0 });
  }
  async resize(e, t2) {
    const [{ resize: r2 }, { default: s }] = await Promise.all([import("./resize-7KJX6H5Q.js"), import("./ResizeParameters-H7JIOG73.js")]), n = new s({ object: e, numUnits: t2 });
    c(this.featureServiceUrl, this.gdbVersion || null) ? (n.sessionId = t, await i(this.featureServiceUrl, this.gdbVersion, true)) : n.sessionId = null, n.gdbVersion = this.gdbVersion;
    const l3 = c2(this.featureServiceUrl, null, this.gdbVersion, false), u2 = await r2(this.networkServiceUrl, n);
    l3.resolve({ edits: null, addedFeatures: [], updatedFeatures: [], deletedFeatures: [], addedAttachments: [], updatedAttachments: [], deletedAttachments: [], exceededTransferLimit: u2.exceededTransferLimit, historicMoment: u2.moment, editedFeatures: u2.serviceEdits || void 0 });
  }
  async query(e) {
    const [{ queryUnitIdentifiers: t2 }, { default: r2 }] = await Promise.all([import("./queryUnitIdentifiers-7ZTJDWVK.js"), import("./QueryUnitIdentifiersParameters-4BKQB2ZA.js")]), s = new r2({ objects: e });
    c(this.featureServiceUrl, this.gdbVersion || null) ? s.sessionId = t : s.sessionId = null, s.gdbVersion = this.gdbVersion, s.moment = this.historicMoment;
    return await t2(this.networkServiceUrl, s);
  }
};
r([m({ type: w, constructOnly: true })], l2.prototype, "utilityNetwork", void 0), r([m()], l2.prototype, "networkServiceUrl", null), r([m()], l2.prototype, "featureServiceUrl", null), r([m()], l2.prototype, "gdbVersion", null), r([m()], l2.prototype, "historicMoment", null), l2 = r([a("esri.networks.UnitIdentifierManager")], l2);
var u = l2;
export {
  u as default
};
//# sourceMappingURL=UnitIdentifierManager-A3ZTQGO6.js.map
