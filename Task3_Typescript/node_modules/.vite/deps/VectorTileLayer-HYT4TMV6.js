...
var l3 = class {
  ...
  _getIndexedDataKey(e4, t3) {
    ...
    let i3 = t3;
    for (; 0 !== i3.level; ) i3 = new e3(i3.level - 1, i3.row >> 1, i3.col >> 1, i3.world), l6.push(i3);
...
var l4 = class {
  ...
  dataKey(e4, t3) {
    const { level: l6, row: s5, col: o6 } = e4, n3 = new e3(e4);
...
var m3 = class {
  constructor(h5, m4, u3) {
    ...
    this.capabilities = { operations: { supportsExportTiles: y, supportsTileMap: T2 }, exportTiles: y ? { maxExportTilesCount: +I2 } : null }, this.tileInfo = j4.fromJSON(c3.tileInfo);
...
function o5(s5, r4) {
  ...
  return new j4({ size: [o6, o6], dpi: i3, format: t3 || "pbf", origin: u3, lods: h5, spatialReference: a5 });
}

// node_modules/@arcgis/core/layers/VectorTileLayer.js
var B = class extends p(t(f2(p2(l2(b2(j3(e2(i2(S(h2)))))))))) {
  constructor(...e4) {
  ...
  load(e4) {
    const r4 = this.loadFromPortal({ supportedTypes: ["Vector Tile Service"], supportsData: false }, e4).catch(a3).then(async () => {
      ...
      (await H(r5, { ...e4, query: { f: "json", ...this.customParameters, token: this.apiKey }, authMode: this.portalItem.portal.authMode })).data && this.read({ url: r5 }, e(this.portalItem, "portal-item"));
  ...
  get tileInfo() {
    ...
    let t3 = this.primarySource?.tileInfo || new j4();
