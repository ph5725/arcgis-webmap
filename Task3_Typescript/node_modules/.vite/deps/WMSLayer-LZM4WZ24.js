...
r([m()], m2.prototype, "description", void 0), r([m({ readOnly: true })], m2.prototype, "dimensions", void 0), r([m({ type: z, json: { name: "extent" } })], m2.prototype, "fullExtent", void 0), r([m()], m2.prototype, "fullExtents", void 0), r([m({ type: Number, json: { write: { enabled: false, overridePolicy: () => ({ ignoreOrigin: true, enabled: true }) } } })], m2.prototype, "id", null), r([m({ type: String, json: { name: "legendUrl", write: { ignoreOrigin: true } } })], m2.prototype, "legendUrl", void 0), r([o("legendUrl", ["legendUrl", "legendURL"])], m2.prototype, "readLegendUrl", null), r([m({ type: Boolean, json: { name: "showLegend", origins: { "web-map": { read: false, write: false }, "web-scene": { read: false, write: false } } } })], m2.prototype, "legendEnabled", void 0), r([m()], m2.prototype, "layer", void 0), r([m()], m2.prototype, "maxScale", void 0), r([m()], m2.prototype, "minScale", void 0), r([m({ readOnly: true })], m2.prototype, "effectiveScaleRange", null), r([m({ type: String, json: { write: { ignoreOrigin: true } } })], m2.prototype, "name", void 0), r([m()], m2.prototype, "parent", void 0), r([m({ type: Boolean, json: { read: { source: "showPopup" }, write: { ignoreOrigin: true, target: "showPopup" } } })], m2.prototype, "popupEnabled", void 0), r([m({ type: Boolean, json: { write: { ignoreOrigin: true } } })], m2.prototype, "queryable", void 0), r([m()], m2.prototype, "sublayers", void 0), r([s3("sublayers")], m2.prototype, "castSublayers", null), r([m({ type: [Number], json: { read: { source: "spatialReferences" } } })], m2.prototype, "spatialReferences", void 0), r([m({ type: String, json: { write: { ignoreOrigin: true } } })], m2.prototype, "title", void 0), r([m({ type: Boolean, value: true, json: { read: { source: "defaultVisibility" } } })], m2.prototype, "visible", null), m2 = h2 = r([a2("esri.layers.support.WMSSublayer")], m2);
...
var Y = class extends p(c(f2(t2(b2(j(S(h))))))) {
  ...
  _defaultFetchFeatureInfoFunction(e) {
    ...
    const s5 = new q({ title: this.title, content: t4 }), i2 = new d2({ sourceLayer: this, popupTemplate: s5 });
