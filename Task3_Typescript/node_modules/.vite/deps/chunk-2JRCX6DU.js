...
async function p(t2, e) {
  ...
  if ("image/gif" === a) {
    const { isAnimatedGIF: t3, parseGif: a2 } = await import("./gif-NSZHZOYI.js");
    if (t3(r)) return a2(r, e);
  }
  if (n) {
    const { isAnimatedPNG: t3, parseApng: a2 } = await import("./apng-EH2EODST.js");
    if (t3(r)) return a2(r, e);
  }
...
//# sourceMappingURL=chunk-2JRCX6DU.js.map
