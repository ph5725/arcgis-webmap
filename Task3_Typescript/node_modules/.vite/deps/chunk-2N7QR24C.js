...
var g = class extends d {
  ...
  async _queryBuddy(e) {
    const t = new (await import("./FeatureLayer-5JKXWSL3.js")).default({ url: e }), { capabilities: r3 } = await t.load(), i2 = r3.query.supportsMaxRecordCountFactor, o4 = r3.query.supportsPagination, s2 = r3.query.supportsCentroid, n = this._config.maxRecordCountFactor, c3 = t.capabilities.query.maxRecordCount, u = i2 ? c3 * n : c3, h3 = new R();
...
//# sourceMappingURL=chunk-2N7QR24C.js.map
