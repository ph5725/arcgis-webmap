...
var m2 = p = class extends t {
  ...
  forwardTransform(e) {
    if ("point" === e.type) {
      const r4 = a2(this.forwardCoefficients, e, this.polynomialOrder);
  ...
  inverseTransform(e) {
    if ("point" === e.type) {
      const r4 = a2(this.inverseCoefficients, e, this.polynomialOrder);
      return new _({ x: r4.x, y: r4.y, spatialReference: e.spatialReference });
    }
...
//# sourceMappingURL=chunk-5726E5A7.js.map
