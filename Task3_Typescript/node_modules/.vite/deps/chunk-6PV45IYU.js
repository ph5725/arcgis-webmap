...
var u5 = n3 = class extends l2 {
  ...
  async fetchItems(t2) {
    ...
    const { default: r2 } = await import("./PortalItem-FI2HERQM.js"), o3 = { folders: false, inRecycleBin: !!t2.inRecycleBin || null, foldersContent: !(t2.folder || !t2.includeSubfolderItems) || null, num: t2.num || 10, start: t2.start || 1, sortField: t2.sortField || "created", sortOrder: t2.sortOrder || "asc" }, s5 = await this.portal.request(e2, { query: o3 });
    let l4;
...
var M;
var U;
var Q = { PortalGroup: () => Promise.resolve({ default: u4 }), PortalItem: () => import("./PortalItem-FI2HERQM.js"), PortalUser: () => Promise.resolve({ default: u5 }) };
var _a;
var C = (_a = class extends l2.JSONSupportMixin(p) {
  ...
  load(e2) {
    const t2 = import("./Basemap-EIZNMNEU.js").then(({ default: t3 }) => {
      s3(e2), U = t3;
  ...
  async createElevationLayers() {
    await this.load();
    const e2 = this._getHelperService("defaultElevationLayers"), t2 = (await import("./ElevationLayer-3CHYBADB.js")).default;
...
//# sourceMappingURL=chunk-6PV45IYU.js.map
