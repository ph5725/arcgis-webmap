...
r([m({ type: String, json: { write: true } })], g.prototype, "displayFieldName", void 0), r([m({ type: Boolean, json: { write: { overridePolicy: (e) => ({ enabled: e }) } } })], g.prototype, "exceededTransferLimit", void 0), r([m({ type: [d], json: { write: true } })], g.prototype, "features", void 0), r([o("features")], g.prototype, "readFeatures", null), r([m({ type: [m2], json: { write: true } })], g.prototype, "fields", void 0), r([m({ type: ["point", "multipoint", "polyline", "polygon", "extent", "mesh"], json: { read: { reader: h.read } } })], g.prototype, "geometryType", void 0), r([r2("geometryType")], g.prototype, "writeGeometryType", null), r([m({ type: Boolean, json: { write: { overridePolicy: (e) => ({ enabled: e }) } } })], g.prototype, "hasM", void 0), r([m({ type: Boolean, json: { write: { overridePolicy: (e) => ({ enabled: e }) } } })], g.prototype, "hasZ", void 0), r([m({ types: l2, json: { write: true } })], g.prototype, "queryGeometry", void 0), r([o("queryGeometry")], g.prototype, "readQueryGeometry", null), r([m({ type: f, json: { write: true } })], g.prototype, "spatialReference", void 0), r([r2("spatialReference")], g.prototype, "writeSpatialReference", null), r([m({ json: { write: true } })], g.prototype, "transform", void 0), g = f3 = r([a2("esri.rest.support.FeatureSet")], g), g.prototype.toJSON.isDefaultToJSON = true;

export {
  g
};
//# sourceMappingURL=chunk-B6C7UPBZ.js.map
