...
function f3(r3, i4) {
  ...
  p3 && (r3.vertex.uniforms.add(new o4("model", (e8) => e8.modelTransformation ?? r)), r3.vertex.uniforms.add(new o2("normalLocalOriginFromModel", (r4) => (j(M, r4.modelTransformation ?? r), M)))), f5 && x && (r3.attributes.add(e2.INSTANCEMODELORIGINHI, "vec3"), r3.attributes.add(e2.INSTANCEMODELORIGINLO, "vec3"), r3.attributes.add(e2.INSTANCEMODEL, "mat3"), r3.attributes.add(e2.INSTANCEMODELNORMAL, "mat3"));
  const _ = r3.vertex;
...
function i2(i4, t5) {
  t5.hasSymbolColors ? (i4.include(a), i4.attributes.add(e2.SYMBOLCOLOR, "vec4"), i4.varyings.add("colorMixMode", "mediump float"), i4.vertex.code.add(n5`int symbolColorMixMode;
vec4 getSymbolColor() {
...
//# sourceMappingURL=chunk-DAJMNP5A.js.map
