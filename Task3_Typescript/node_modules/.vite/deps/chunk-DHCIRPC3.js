...
function B3(t3, n5, r3) {
  ...
  if (a(e3, n5) && (!a4 || B(a4.localMatrix, r)) && Y2(s2)) {
...
function V2(t3, n5) {
  return n5?.useEllipsoid && A(t3) ? w2 : a3(t3);
}
...
function z(t3, n5, r3) {
  ...
  if (!r3) {
    ...
    return { position: a2(new Float64Array(r4.length), r4, n5), tangent: o4, normal: e4 };
  }
  const e3 = I(t3, r3.localMatrix);
  return a2(e3.position, e3.position, n5), e3;
}
...
//# sourceMappingURL=chunk-DHCIRPC3.js.map
