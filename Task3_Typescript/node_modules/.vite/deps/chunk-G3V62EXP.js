...
var d5 = class extends P2 {
  getVVRotationMat4(t10) {
    return zt(w3(t10), ct.identity(), () => {
      const e10 = this.getNormalizedAngle(t10).multiply(t4), r7 = sn(e10), i11 = oe2(e10);
...
var t8 = class extends t5 {
  constructor() {
    super(...arguments), this.symbologyPlane = S2.FILL, this._input = null;
  }
};
...
var m5 = class extends l4 {
  constructor() {
    super(...arguments), this.type = e2.AnimatedMarker, this.symbologyPlane = S2.MARKER, this.shaders = { geometry: new q8() };
  }
};
var n6 = class extends l4 {
  constructor() {
    super(...arguments), this.type = e2.AnimatedMarkerShift, this.symbologyPlane = S2.MARKER, this.shaders = { geometry: new q8() };
  }
};
var a4 = class extends l4 {
  constructor() {
    super(...arguments), this.type = e2.AnimatedFill, this.symbologyPlane = S2.FILL, this.shaders = { geometry: new f6() };
  }
};
var h6 = class extends l4 {
  constructor() {
    super(...arguments), this.type = e2.AnimatedLine, this.symbologyPlane = S2.LINE, this.shaders = { geometry: new A4() };
  }
};
...
var C6 = class extends j {
  ...
  vertex(t10) {
    const o14 = new rt(1, 0, 0, 0, -1, 0, 0, 1, 1).multiply(new X2(t10.pos.xy.divide(a2), 1)), i11 = yn(this.draw.locations, o14.xy), s9 = Ce(this.instance.dotSize.divide(2), new _3(1));
    let r7 = new _3(0);
...
var F5 = class extends B5 {
  ...
  vertex(t10) {
    const e10 = new rt(2 / a2, 0, 0, 0, -2 / a2, 0, -1, 1, 1).multiply(new X2(t10.pos, 1)), s9 = this.clip(t10.id), i11 = new Y2(e10.xy, s9, 1), r7 = this.storage.getVVData(t10.id).multiply(this.instance.isActive.get(0)).multiply(t10.inverseArea), l10 = this.storage.getDataDrivenData0(t10.id).multiply(this.instance.isActive.get(1)).multiply(t10.inverseArea), d10 = this.draw.tileZoomFactor.multiply(a2).divide(this.draw.pixelRatio), n15 = this._dotThreshold(r7, this.instance.dotValue, this.draw.tileDotsOverArea), c7 = this._dotThreshold(l10, this.instance.dotValue, this.draw.tileDotsOverArea), u11 = t10.pos.add(0.5).divide(d10);
...
var f7 = class {
  ...
  getFBO(t10) {
    if (null == this._dotFBO) {
      const s9 = a2, n15 = a2, h11 = new a(s9, n15);
  ...
  getDotDensityMesh(t10) {
    if (null == this._dotMesh) {
      const o14 = a2, r7 = o14 * o14, i11 = 2, n15 = new Int16Array(r7 * i11);
  ...
  _allocDotDensityTexture(t10, e10, s9) {
    ...
    const i11 = new a();
    return i11.dataType = X.FLOAT, i11.samplingMode = L3.NEAREST, i11.width = e10, i11.height = e10, new S(t10, i11, r7);
  }
};
...
var u5 = class extends t8 {
  constructor() {
    super(...arguments), this.type = e2.GradientFill, this.shaders = { geometry: new A6() }, this.symbologyPlane = S2.FILL;
  }
  render(e10, t10) {
...
var f8 = class {
  ...
  ensureAccumulateFBO(e10, r7, t10) {
    if (null == this._accumulateFramebuffer) {
      const { dataType: u11, samplingMode: o14, pixelFormat: m17, internalFormat: f15 } = this.loadQualityProfile(e10), h11 = new a(r7, t10);
  ...
  ensureResolveGradientTexture(e10, r7, t10) {
    if (null == this._resolveGradientTexture) {
      const r8 = new a();
      r8.wrapMode = P.CLAMP_TO_EDGE, this._resolveGradientTexture = new S(e10, r8), this._prevGradientHash = null;
    }
...
var l7 = class extends t8 {
  constructor() {
    super(...arguments), this.type = e2.Label, this.shaders = { geometry: new $() }, this.drawPhase = E2.LABEL | E2.LABEL_ALPHA | E2.HITTEST, this.symbologyPlane = S2.TEXT;
  }
  render(e10, s9) {
...
var d6 = class extends t8 {
  constructor() {
    super(...arguments), this.type = e2.GradientStroke, this.shaders = { geometry: new k4() }, this.symbologyPlane = S2.LINE;
  }
...
var p7 = class extends t8 {
  constructor() {
    super(...arguments), this.type = e2.Line, this.shaders = { geometry: new _6() }, this.symbologyPlane = S2.LINE;
  }
  render(e10, t10) {
...
var p8 = class extends t8 {
  constructor() {
    super(...arguments), this.type = e2.TexturedLine, this.shaders = { geometry: new H6() }, this.symbologyPlane = S2.LINE;
  }
  render(e10, t10) {
...
var u6 = class extends t8 {
  constructor() {
    super(...arguments), this.type = e2.Marker, this.shaders = { geometry: new et() }, this.symbologyPlane = S2.MARKER;
  }
  render(e10, t10) {
    const { context: a8, painter: m17 } = e10, u11 = t10.instance.getInput();
...
var n11 = class extends t8 {
  constructor() {
    super(...arguments), this.type = e2.PieChart, this.shaders = { geometry: new u7() }, this.symbologyPlane = S2.MARKER;
  }
  render(e10, t10) {
...
var m12 = class extends t8 {
  constructor() {
    super(...arguments), this.type = e2.Text, this.shaders = { geometry: new $() }, this.symbologyPlane = S2.TEXT;
  }
  render(e10, s9) {
...
function g10() {
  const { supportsColorBufferFloat: e10, supportsColorBufferFloatBlend: o14, supportsColorBufferHalfFloat: r7 } = t3();
  return e10 && o14 || r7;
}
function m13(o14) {
  if (!o14) return true;
  switch (o14.type) {
    ...
    case "heatmap":
      if (!g10()) {
        const o15 = t3(), r7 = ["supportsColorBufferFloat", "supportsColorBufferFloatBlend", "supportsColorBufferHalfFloat"].filter((e10) => !o15[e10]).join(", ");
...
function m15(e10, a8, l10, t10) {
  ...
  return [e10.createMeshInfo({ pixelDimensions: a8.pixelDimensions, texelDimensions: a8.texelDimensions, effects: a8.effects ? { type: "cim-effect-infos", effectInfos: a8.effects } : null, sprite: i9(a8), animations: a8.animationParams, scaleInfo: t10.scaleInfo, scaleSymbolsProportionally: a8.scaleSymbolsProportionally, strokeWidth: a8.outlineWidth, isMapAligned: a8.alignment === i2.MAP, colorLocked: a8.colorLocked, isStroke: a8.isStroke, baseSize: a8.baseSize, placement: a8.markerPlacement, referenceSize: a8.referenceSize, angleToLine: !!a8.markerPlacement && (a8.markerPlacement.placement && "angleToLine" in a8.markerPlacement.placement && a8.markerPlacement.placement.angleToLine), sizeRatio: a8.sizeRatio, patternHeight: null })];
}
...
function a7(e10, i11) {
  return { type: "simple", filters: i11, capabilities: { maxTextureSize: t3().maxTextureSize }, bindings: u10(e10) };
}
...
//# sourceMappingURL=chunk-G3V62EXP.js.map
