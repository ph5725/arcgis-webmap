...
function t3(n17) {
  ...
  return t11[0] = n17[0], t11[1] = n17[1], t11[2] = n17[2], t11[3] = n17[3], t11;
}
function r5(n17, t11, r12, e14) {
  const o8 = new Float32Array(4);
  return o8[0] = n17, o8[1] = t11, o8[2] = r12, o8[3] = e14, o8;
}
function e10() {
  return n11();
}
...
var y = i4();
var N3 = f3();
var T = Object.freeze(Object.defineProperty({ __proto__: null, ONES: l3, UNIT_W: N3, UNIT_X: _2, UNIT_Y: s6, UNIT_Z: y, ZEROS: a4, clone: t3, create: n11, fromValues: r5, ones: o5, unitW: f3, unitX: u2, unitY: c, unitZ: i4, zeros: e10 }, Symbol.toStringTag, { value: "Module" }));
...
var r7 = class extends e9 {
  ...
  setTransform(i6) {
    const s11 = this.resolution / (i6.resolution * i6.pixelRatio), r12 = this.transforms.tileMat3, [n17, o8] = i6.toScreenNoRotation([0, 0], [this.x, this.y]), h5 = this.width / this.rangeX * s11, l7 = this.height / this.rangeY * s11;
    r(r12, h5, 0, 0, 0, l7, 0, n17, o8, 1), i3(this.transforms.displayViewScreenMat3, i6.displayViewMat3, r12);
  }
  get destroyed() {
...
var g = class extends r7 {
  ...
  setTransform(m3) {
    ...
    const x3 = r4(n6(), d5, 0, 0, u8, f5, p3);
    e4(this.transforms.labelMat2d, m3.viewMat2d, x3);
    const M3 = [0, 0];
    m3.toScreen(M3, [this.x, this.y]);
    const g4 = this.transforms.tileUnitsToPixels;
    o2(g4), M(g4, g4, M3), h(g4, g4, Math.PI * m3.rotation / 180), f(g4, g4, [d5, u8, 1]);
  }
  _createTransforms() {
    return { labelMat2d: n6(), tileMat3: e6(), displayViewScreenMat3: e6(), tileUnitsToPixels: e6() };
  }
  containsScreenPoint(t11, s11, i6) {
    const r12 = i3(x, t11.viewMat3, this.transforms.tileMat3), e14 = s2(x, r12);
    if (null == e14) return true;
    o(M2, ...s11, 1);
    const a10 = N(M2, M2, e14), n17 = i6 * (this.resolution / t11.resolution);
    return a10[0] >= -n17 && a10[0] < this.width + n17 && a10[1] >= -n17 && a10[1] < this.height + n17;
  }
};
...
var t6 = class _t {
  constructor(a10) {
    ...
    this.data = a10[0];
    let e14 = this;
    for (let n17 = 1; n17 < a10.length; n17++) e14.next = new _t([a10[n17]]), e14 = e14.next;
  }
  *values() {
    let t11 = this;
  ...
  forEach(t11) {
    let a10 = this;
    for (; a10; ) t11(a10.data), a10 = a10.next;
  }
  get last() {
...
var a5 = class {
  constructor(a10) {
    this._head = null, null != a10 && (this._head = new t6(a10));
  }
  get head() {
    return this._head;
  }
  maxAvailableSpace() {
    ...
    return this._head.forEach((a10) => {
      const e14 = a10.end - a10.start;
      t11 = Math.max(t11, e14);
    }), t11;
  }
  firstFit(t11) {
    if (null == this._head) return null;
    let a10 = null, e14 = this._head;
    for (; e14; ) {
      const n17 = e14.data.end - e14.data.start;
      if (n17 === t11) return a10 ? a10.next = e14.next : this._head = e14.next, e14.data.start;
      if (n17 > t11) {
        const a11 = e14.data.start;
        return e14.data.start += t11, a11;
      }
      a10 = e14, e14 = e14.next;
    }
    return null;
  }
  free(a10, e14) {
    const n17 = a10 + e14;
    if (null == this._head) {
      const e15 = new t6({ start: a10, end: n17 });
      return void (this._head = e15);
    }
    if (n17 <= this._head.data.start) {
      if (n17 === this._head.data.start) return void (this._head.data.start -= e14);
      const r13 = new t6({ start: a10, end: n17 });
      return r13.next = this._head, void (this._head = r13);
    }
    let r12 = this._head, d5 = r12.next;
    for (; d5; ) {
      if (d5.data.start >= n17) {
        if (r12.data.end === a10) {
        ...
        if (d5.data.start === n17) return void (d5.data.start -= e14);
        const s12 = new t6({ start: a10, end: n17 });
        return s12.next = r12.next, void (r12.next = s12);
      }
      r12 = d5, d5 = d5.next;
    }
    if (a10 === r12.data.end) return void (r12.data.end += e14);
    const s11 = new t6({ start: a10, end: n17 });
    r12.next = s11;
  }
  clear() {
    this._head = null;
...
var a6 = class _a {
  constructor() {
    this._data = new ArrayBuffer(_a.BYTE_LENGTH), this._freeList = new a5({ start: 0, end: this._data.byteLength });
  }
...
var i5 = class {
  ...
  get _bytesTotal() {
    return this._pages.length * a6.BYTE_LENGTH;
  }
  acquireUint32Array(e14) {
    if (this._bytesAllocated += e14, r8 && console.log(`Allocating ${e14}, (${this._bytesAllocated} / ${this._bytesTotal})`), e14 >= a6.BYTE_LENGTH) return new Uint32Array(e14 / Uint32Array.BYTES_PER_ELEMENT);
...
var o7 = class {
  constructor(t11, i6, r12, s11) {
    this._pool = s11;
    const n17 = s7.create(i6 * r12 * Uint32Array.BYTES_PER_ELEMENT, this._pool);
    this.size = i6, this.strideInt = r12, this.bufferType = t11, this.dirty = { start: 1 / 0, end: 0 }, this.memoryStats = { bytesUsed: 0, bytesReserved: i6 * r12 * Uint32Array.BYTES_PER_ELEMENT }, this._gpu = null, this._cpu = n17, this.clear();
  }
  get elementSize() {
  ...
  clear() {
    ...
    if (t11 * this.strideInt > this._cpu.length - this.fillPointer) {
      this.invalidate();
      const i6 = this._cpu.length / this.strideInt, r12 = Math.round((i6 + t11) * a7), e14 = r12 * this.strideInt;
  ...
  insert(i6, r12, e14, s11) {
    const n17 = e14 * this.strideInt;
    if (!n17) return 0;
    const h5 = r12 * this.strideInt * Uint32Array.BYTES_PER_ELEMENT, a10 = new Uint32Array(i6, h5, n17), d5 = this.freeList.firstFit(e14);
    n(d5, "First fit region must be defined");
    const u8 = d5 * this.strideInt, o8 = n17;
    if (this._cpu.array.set(a10, u8), 0 !== s11) for (let t11 = 0; t11 < a10.length; t11++) this._cpu.array[t11 + u8] += s11;
  ...
  copyFrom(i6, r12, e14, s11, n17) {
    const h5 = e14 * this.strideInt;
    if (!h5) return 0;
    const a10 = r12 * this.strideInt * Uint32Array.BYTES_PER_ELEMENT, d5 = i6._cpu.getUint32View(a10, h5), u8 = this.freeList.firstFit(e14);
    n(u8, "First fit region must be defined");
    const o8 = u8 * this.strideInt, f5 = h5;
    if (this._cpu.array.set(d5, o8), 0 !== s11) for (let t11 = 0; t11 < h5; t11++) this._cpu.array[o8 + t11 * this.strideInt + n17] += s11;
  ...
  free(t11, i6, r12) {
    ...
    if (true === r12) for (let n17 = t11; n17 !== t11 + i6; n17++) this._cpu.array[n17 * this.strideInt] = u3;
  ...
  reshuffle(t11, i6) {
    ...
    const r12 = this.byteSize, s11 = t11 * this.strideInt * Uint32Array.BYTES_PER_ELEMENT, n17 = r12 > s11, h5 = this._cpu, a10 = s7.create(s11, this._pool);
    n17 || a10.array.set(this._cpu.getUint32View(0, this.intSize));
    for (const e14 of i6) if (n17 || e14.srcFrom !== e14.dstFrom || 0 !== e14.mutate) {
      ...
      for (let t12 = 0; t12 < e14.count; t12++) {
        ...
        for (let t13 = 0; t13 < this.strideInt; t13++) a10.array[i7 + t13] = h5.array[r13 + t13] + e14.mutate;
      }
    }
    this._cpu.destroy(), this._cpu = a10, n17 && this.invalidate(), this.freeList.clear(), this.memoryStats.bytesUsed = this.memoryStats.bytesReserved = s11;
  }
  _createBuffer(t11) {
...
var l4 = { hash: t2(h3), attributes: h3, stride: a8 };
function _3(e14, t11) {
...
var y2 = class {
  ...
  getDebugVertexInfo(e14 = false, t11) {
    ...
    for (let _6 = 0; _6 < u8; _6++) {
      ...
      for (const e15 of [...i6.attributes, ...o8]) {
        let i7 = `${e15.offset} ${e15.name}`, s12 = s5(n17, e15, h5);
  ...
  _ensure(e14, t11) {
    if (this._vertexBuffer && this._indexBuffer) this._indexBuffer.ensure(Math.max(e14, u4)), this._vertexBuffer.ensure(Math.max(t11, u4)), this._visibilityBuffer && this._visibilityBuffer.ensure(Math.max(t11, u4));
      ...
      this._indexBuffer = new o7("index", Math.max(e14, u4), 1, this._bufferPool), this._vertexBuffer = new o7("vertex", Math.max(t11, u4), r12, this._bufferPool), this.useVisibility && (this._visibilityBuffer = new o7("vertex", Math.max(t11, u4), a8 / Uint32Array.BYTES_PER_ELEMENT, this._bufferPool));
    }
  }
  append(e14) {
    const t11 = e14.layout.stride, i6 = e14.indices.byteLength / Uint32Array.BYTES_PER_ELEMENT, r12 = e14.vertices.byteLength / t11;
    this._ensure(i6, r12);
    const { vertices: s11, indices: f5 } = e14, o8 = this._vertexBuffer.insert(s11, 0, s11.byteLength / t11, 0), n17 = new Uint32Array(r12);
    new Float32Array(n17.buffer).fill(255), this._visibilityBuffer && this._visibilityBuffer.insert(n17, 0, n17.byteLength / a8, 0);
  ...
  setEntityRecordRangeVisibility(e14, t11, i6, r12) {
    for (let s11 = t11; s11 < t11 + i6; s11++) {
  ...
  copyRecordFrom(e14, i6, r12, s11) {
    const { indexStart: f5, indexCount: o8, vertexStart: n17, vertexCount: u8 } = i6;
    this._ensure(o8, u8);
    const a10 = e14._position, h5 = r12 * (a10.packPrecisionFactor ?? 1), l7 = s11 * (a10.packPrecisionFactor ?? 1), _6 = a10.offset, d5 = s4(h5, l7), y5 = this._vertexBuffer.copyFrom(e14._vertexBuffer, n17, u8, d5, _6);
    this._visibilityBuffer && e14._visibilityBuffer && this._visibilityBuffer.copyFrom(e14._visibilityBuffer, n17, u8, 0, 0);
    const v = this._indexBuffer.copyFrom(e14._indexBuffer, f5, o8, y5 - n17, 0), c4 = i6.clone();
...
var h4 = class {
  constructor(t11, e14, n17, i6, a10) {
    this.instance = t11, this.materialKey = e14, this.target = n17, this.start = i6, this.count = a10;
  }
  get textureKey() {
  ...
  drawCompute(t11, e14) {
    const n17 = this.instance.instanceId, i6 = this.target.getMesh(n17).getComputeVAO(t11, e14), r12 = this.start * Uint32Array.BYTES_PER_ELEMENT / 3;
    t11.bindVAO(i6), t11.drawElements(R.POINTS, this.count / 3, O.UNSIGNED_INT, r12), t11.bindVAO(null);
  }
  drawGeometry(t11, e14) {
    const n17 = this.instance.instanceId, i6 = this.target.getMesh(n17).getGeometryVAO(t11, e14), r12 = this.start * Uint32Array.BYTES_PER_ELEMENT;
...
var l5 = class _l {
  ...
  static fromDisplayEntities(t11, e14, n17, i6) {
    const a10 = new _l();
    for (const s11 of t11.values()) for (const t12 of s11.records) {
      const s12 = n17.getInstance(t12.instanceId), d5 = r10(s12.instanceId, t12.textureKey);
      a10.addRecord(s12, d5, t12.indexStart, t12.indexCount, t12.vertexStart, t12.vertexCount, e14, i6);
    }
    return a10;
  }
  get length() {
  ...
  render(t11, e14) {
    const { drawPhase: n17 } = t11;
    for (const i6 of this.infos()) {
      const a10 = i6.instance.techniqueRef;
      a10.drawPhase & n17 && (null == e14 || a10.type === e14) && i6.render(t11);
    }
  }
  addRecord(i6, a10, s11, r12, d5, l7, o8, c4) {
    let u8 = s11, _6 = r12;
    if (_6 || (u8 = d5, _6 = l7), !_6) return;
    if (null == this._head) {
      const t11 = new h4(i6, a10, o8, u8, _6);
      return this._head = new t6(t11), this._tail = this._head, this._length++, void this._minOrderedLength++;
    }
    if (c4 === N2.STRICT_ORDER) return this._insert(i6, a10, o8, u8, _6, this._tail, null);
    let g4 = null, m3 = this._head;
    const f5 = i6.instanceId, y5 = i6.techniqueRef.symbologyPlane;
    if (c4 === N2.STRICT_MARKERS_AND_TEXT && (y5 === S3.MARKER || y5 === S3.TEXT)) return this._insert(i6, a10, o8, u8, _6, this._tail, null);
    for (; m3; ) {
      const t11 = m3.data.instance, e14 = t11.instanceId, n17 = t11.techniqueRef.symbologyPlane, s12 = g4?.data.instance.instanceId;
      if (y5 < n17 || f5 === s12 && f5 !== e14) return this._insert(i6, a10, o8, u8, _6, g4, m3);
      g4 = m3, m3 = m3.next;
    }
    this._insert(i6, a10, o8, u8, _6, g4, null);
  }
  *infos() {
    if (null != this._head) for (const t11 of this._head.values()) yield t11;
  }
  _insert(t11, e14, i6, a10, s11, r12, d5) {
    if (null == r12 && null == d5) {
      const r13 = new h4(t11, e14, i6, a10, s11);
      return this._head = new t6(r13), this._tail = this._head, this._length++, void this._minOrderedLength++;
    }
    return e14 !== this._tail.data.materialKey && this._minOrderedLength++, this._materialKeys.add(e14), null == r12 && null != d5 ? this._insertAtHead(t11, e14, i6, a10, s11, d5) : null != r12 && null == d5 ? this._insertAtEnd(t11, e14, i6, a10, s11, r12) : null != r12 && null != d5 ? this._insertAtMiddle(t11, e14, i6, a10, s11, r12, d5) : void 0;
  }
  _insertAtHead(t11, e14, i6, a10, s11, r12) {
    const d5 = a10 + s11;
    if (e14 === r12.data.materialKey && i6 === r12.data.target && d5 === r12.data.start) r12.data.start = a10, r12.data.count += s11;
    else {
      const d6 = new h4(t11, e14, i6, a10, s11);
      this._head = new t6(d6), this._head.next = r12, this._length++;
    }
  }
  _insertAtEnd(t11, e14, i6, a10, s11, r12) {
    if (r12.data.materialKey === e14 && r12.data.indexEnd === a10) r12.data.count += s11;
    else {
      const d5 = new h4(t11, e14, i6, a10, s11);
      this._tail = new t6(d5), r12.next = this._tail, this._length++;
    }
  }
  _insertAtMiddle(t11, e14, i6, a10, s11, r12, d5) {
    const l7 = a10 + s11;
    if (r12.data.materialKey === e14 && r12.data.target === i6 && r12.data.indexEnd === a10) r12.data.count += s11, r12.data.materialKey === d5.data.materialKey && r12.data.target === d5.data.target && r12.data.indexEnd === d5.data.start && (r12.data.count += d5.data.count, r12.next = d5.next, this._length--);
    else if (e14 === d5.data.materialKey && i6 === d5.data.target && l7 === d5.data.start) d5.data.start = a10, d5.data.count += s11;
    else {
      const l8 = new h4(t11, e14, i6, a10, s11), o8 = new t6(l8);
...
var t7 = class {
  ...
  copyRecord(t11) {
    ...
    if (this._indexOnly && this.index.operations.length >= 1) {
      ...
      e15.srcFrom + e15.count === t11.indexStart && (e15.count += t11.indexCount, n17 = true);
    }
    n17 || this.index.operations.push({ srcFrom: t11.indexStart, dstFrom: this.index.count, count: t11.indexCount, mutate: e14 }), t11.indexStart = this.index.count, this.index.count += t11.indexCount;
  }
};
...
function s8(e14) {
  if (!e14) return null;
  return { entities: n5(new t8(e14.entities), s3), vertexData: e14.data.map(a9) };
}
function a9(t11) {
  const s11 = t11.layout.stride, a10 = new DataView(t11.vertices), n17 = [], c4 = t11.vertices.byteLength / s11;
  let l7 = 0;
  for (let e14 = 0; e14 < c4; e14++) {
    const e15 = {};
    for (const r12 of t11.layout.attributes) {
      let t12 = `${r12.offset} ${r12.name}`, o8 = s5(a10, r12, l7);
  ...
  const f5 = t11.metrics ? n5(new t8(t11.metrics), n7) ?? [] : [];
  return { vertices: n17, layout: t11.layout, metrics: f5 };
}
...
var I = class extends g {
  constructor(e14, i6, r12, o8, d5, n17, h5 = false) {
    super(e14, i6, r12, o8), this._fader = d5, this._labelInstanceId = n17, this._meshes = /* @__PURE__ */ new Map(), this._entities = [], this._entityIndex = /* @__PURE__ */ new Map(), this._invalidated = false, this._nextUploadAllowed = false, this.tileAge = g2++, this._metrics = [], this._metricsVisibility = /* @__PURE__ */ new Set(), this._entityIds = /* @__PURE__ */ new Set(), this._entityIdsFromBuffer = /* @__PURE__ */ new Set(), this._attributeEpoch = 0, this._encounteredEnd = false, this.neededForCoverage = false, this.isCoverage = false, this.rendering = false, this._decluttered = false, this._objectIdMap = null, this.visible = true, this.transforms.labelMat2d = n6(), this.transforms.tileUnitsToPixels = e6(), this.enableDeferredUploads = h5;
  }
  destroy() {
  ...
  _onAppendMessage(e14) {
    ...
    const t11 = n5(new t8(e14.append.entities), s3);
  ...
  _onUpdateMessage(e14) {
    ...
    const t11 = n5(new t8(e14.modify.entities), s3), s11 = t11.map((e15) => e15.id), i6 = e14.isPixelBuffer ?? false, r12 = [...e14.remove, ...s11];
  ...
  copyPixelBufferedEntitesFrom(e14, t11, s11, i6) {
    const r12 = s11 * a2, o8 = i6 * a2;
    for (const d5 of e14._entities) {
      let s12 = null;
      for (const i7 of d5.records) if (i7.overlaps & t11) {
        const t12 = e14.getMesh(i7.instanceId), n17 = this._ensureMesh(i7.instanceId, t12.layout, t12.useVisibility).copyRecordFrom(t12, i7, r12, o8);
        s12 || (s12 = new s3(d5.id, d5.sortKey), this._entityIdsFromBuffer.add(d5.id), this._entityIndex.set(s12.id, s12), this._entities.push(s12)), s12.records.push(n17);
      }
    }
  ...
  _insertVertexData(e14) {
    ...
    for (const s11 of e14) {
      ...
      if (s11.metrics) {
        const e16 = n5(new t8(s11.metrics), n7) ?? [];
...
var t9 = class {
  ...
  drawMany(t11, r12, s11) {
    for (const a10 of r12) a10.visible && this.draw(t11, a10, s11);
  }
};
...
var _4 = class extends t9 {
  ...
  _initialize(e14) {
    ...
    if (!t11) return false;
    const o8 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), a10 = E2.createVertex(e14, Y.STATIC_DRAW, o8), l7 = new o4(e14, e12.attributes, r6, /* @__PURE__ */ new Map([["geometry", a10]]));
...
var y3 = class extends t9 {
  ...
  draw(e14, t11) {
    ...
    const n17 = this._getTexture(o8, t11);
    n17 ? (o8.bindVAO(this._tileInfoVertexArrayObject), o8.useProgram(this._tileInfoProgram), o8.bindTexture(n17, 0), this._tileInfoProgram.setUniformMatrix3fv("u_dvsMat3", t11.transforms.displayViewScreenMat3), this._tileInfoProgram.setUniform1f("u_depth", 0), this._tileInfoProgram.setUniform2f("u_coord_ratio", t11.rangeX / t11.width, t11.rangeY / t11.height), this._tileInfoProgram.setUniform2f("u_delta", 0, 0), this._tileInfoProgram.setUniform2f("u_dimensions", n17.descriptor.width, n17.descriptor.height), o8.drawArrays(R.TRIANGLE_STRIP, 0, 4), o8.bindVAO()) : o8.bindVAO();
  }
  _loadWGLResources(e14) {
    if (this._outlineProgram && this._tileInfoProgram) return;
    const r12 = e8(e14, e12), o8 = e8(e14, r9), a10 = new Int8Array([0, 0, 1, 0, 1, 1, 0, 1]), l7 = E2.createVertex(e14, Y.STATIC_DRAW, a10), m3 = new o4(e14, e12.attributes, r6, /* @__PURE__ */ new Map([["geometry", l7]])), u8 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), d5 = E2.createVertex(e14, Y.STATIC_DRAW, u8), h5 = new o4(e14, r9.attributes, r6, /* @__PURE__ */ new Map([["geometry", d5]]));
  ...
  _getTexture(e14, t11) {
    ...
    if (!t11.tileDebugInfoTexture) {
      const r13 = new a();
      r13.wrapMode = P.CLAMP_TO_EDGE, r13.samplingMode = L.LINEAR, r13.isImmutable = true, r13.width = _5, r13.height = x2, t11.tileDebugInfoTexture = new S2(e14, r13);
    }
    const r12 = this._ctx;
    ...
    const { debugInfo: n17 } = t11;
    if (n17) {
      const { length: e15, minOrderedLength: t12, minUnorderedLength: o9, triangleCount: s12 } = n17.display;
      if (e15 > 0) {
      ...
      const { bytesUsed: a10, bytesReserved: l7 } = n17.memory;
      if (r12.fillStyle = "white", r12.strokeStyle = "black", a10 > 0 || l7 > 0) {
        const e16 = `Memory usage: ${a10} of ${l7} bytes`;
        r12.strokeText(e16, p2, i6), r12.fillText(e16, p2, i6), i6 += b2;
      }
    }
...
var u5 = class extends t9 {
  ...
  drawMany(e14, r12) {
    const { context: s11, painter: a10, requestRender: f5, allowDelayedRender: m3 } = e14;
    this._loadWGLResources(e14);
    const u8 = e14.displayLevel, p3 = e14.styleLayer, _6 = p3.backgroundMaterial, d5 = a10.vectorTilesMaterialManager, g4 = p3.getPaintValue("background-color", u8), h5 = p3.getPaintValue("background-opacity", u8), x3 = p3.getPaintValue("background-pattern", u8), M3 = void 0 !== x3, b3 = 1 | window.devicePixelRatio, v = e14.spriteMosaic;
    let y5, w;
    ...
    if (!m3 || null == f5 || L2.compiled) {
      if (s11.bindVAO(this._vao), s11.useProgram(L2), M3) {
        ...
        if (null != t11) {
          ...
          const a11 = v.getPageSize(i6);
          null != a11 && (v.bind(s11, L.LINEAR, i6, Z), L2.setUniform4f("u_tlbr", e15[0], e15[1], r13[0], r13[1]), L2.setUniform2fv("u_mosaicSize", a11), L2.setUniform1i("u_texture", Z));
        }
  ...
  _loadWGLResources(t11) {
    if (this._vao) return;
    const { context: e14, styleLayer: r12 } = t11, o8 = r12.backgroundMaterial, i6 = new Int8Array([0, 0, 1, 0, 0, 1, 1, 1]), s11 = E2.createVertex(e14, Y.STATIC_DRAW, i6), n17 = new o4(e14, o8.getAttributeLocations(), o8.getLayoutInfo(), /* @__PURE__ */ new Map([["geometry", s11]]));
    this._vao = n17;
  }
};

// node_modules/@arcgis/core/views/2d/engine/webgl/brushes/WGLBrushVTLCircle.js
var n14 = class extends t9 {
  constructor() {
  ...
  drawMany(t11, n17) {
    ...
    if (!n17.some((e14) => e14.layerData.get(f5)?.circleIndexCount ?? false)) return;
    ...
    l7.useProgram(U), U.setUniformMatrix3fv("u_displayMat3", x3 === r3.VIEWPORT ? c4.displayMat3 : c4.displayViewMat3), U.setUniform2fv("u_circleTranslation", E3), U.setUniform1f("u_depth", y5.z), U.setUniform1f("u_antialiasingWidth", v);
    let _6 = -1;
    for (const e14 of n17) {
      ...
      const n18 = t12.vao;
      null != n18 && (l7.bindVAO(n18), U.setUniformMatrix3fv("u_dvsMat3", e14.transforms.displayViewScreenMat3), o8 !== e14.key.level ? l7.setStencilFunction(C.EQUAL, e14.stencilRef, 255) : l7.setStencilFunction(C.GREATER, 255, 255), l7.drawElements(R.TRIANGLES, t12.circleIndexCount, O.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * t12.circleIndexStart), e14.triangleCount += t12.circleIndexCount / 3);
    }
  }
};
...
var f4 = class extends t9 {
  ...
  drawMany(t11, e14) {
    const { displayLevel: i6, renderPass: n17, spriteMosaic: a10, styleLayerUID: l7 } = t11;
    let r12 = false;
    ...
    if (f5 && !u8) {
      ...
      c4 = a10.getMosaicItemPosition(t12, true);
    }
    ...
    if (p3 && "opaque" === n17) return;
    const y5 = o8.getPaintValue("fill-translate", i6), g4 = o8.getPaintValue("fill-translate-anchor", i6);
    (p3 || "translucent" !== n17) && this._drawFill(t11, l7, o8, e14, y5, g4, f5, c4, u8);
    const M3 = !o8.hasDataDrivenOutlineColor && o8.outlineUsesFillColor && m3 < 1;
    d5 && "opaque" !== n17 && !M3 && this._drawOutline(t11, l7, o8, e14, y5, g4);
  }
  _drawFill(n17, f5, u8, c4, d5, p3, m3, y5, g4) {
    if (m3 && !g4 && null == y5) return;
    const { context: M3, displayLevel: _6, state: E3, painter: v, pixelRatio: P2, spriteMosaic: U, requestRender: I2, allowDelayedRender: x3 } = n17, D2 = u8.fillMaterial, R2 = v.vectorTilesMaterialManager, S4 = P2 > _ ? 2 : 1, T3 = this._fillProgramOptions;
    T3.pattern = m3;
    ...
    h5.setUniformMatrix3fv("u_displayMat3", p3 === r3.VIEWPORT ? E3.displayMat3 : E3.displayViewMat3), h5.setUniform2fv("u_fillTranslation", d5), h5.setUniform1f("u_depth", u8.z + s9);
    let w = -1;
    for (const t11 of c4) {
      ...
      const n18 = i6.fillVAO;
      if (null != n18) {
        if (M3.bindVAO(n18), h5.setUniformMatrix3fv("u_dvsMat3", t11.transforms.displayViewScreenMat3), M3.setStencilFunction(C.EQUAL, t11.stencilRef, 255), m3) {
        ...
        if (g4) {
          ...
          if (!t12) continue;
          for (const [i7, n19] of t12) {
            const t13 = U.getPageSize(i7);
            null != t13 && (U.bind(M3, L.LINEAR, i7, Z), h5.setUniform2fv("u_mosaicSize", t13), h5.setUniform1i("u_texture", Z), M3.drawElements(R.TRIANGLES, n19[1], O.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * n19[0]));
          }
  ...
  _drawOutline(e14, i6, n17, a10, f5, u8) {
    const { context: c4, displayLevel: d5, state: p3, painter: m3, pixelRatio: y5, spriteMosaic: g4, requestRender: M3, allowDelayedRender: _6 } = e14, E3 = n17.outlineMaterial, v = m3.vectorTilesMaterialManager, P2 = 0.75 / y5, U = this._outlineProgramOptions, I2 = v.getMaterialProgram(c4, E3, U);
    if (_6 && null != M3 && !I2.compiled) return void M3();
    c4.useProgram(I2), I2.setUniformMatrix3fv("u_displayMat3", u8 === r3.VIEWPORT ? p3.displayMat3 : p3.displayViewMat3), I2.setUniform2fv("u_fillTranslation", f5), I2.setUniform1f("u_depth", n17.z + s9), I2.setUniform1f("u_outline_width", P2);
    let x3 = -1;
    for (const t11 of a10) {
      if (!t11.layerData.has(i6)) continue;
      t11.key.level !== x3 && (x3 = t11.key.level, E3.setDataUniforms(I2, d5, n17, x3, g4));
      const e15 = t11.layerData.get(i6);
      if (e15.prepareForRendering(c4), !e15.outlineIndexCount) continue;
      const a11 = e15.outlineVAO;
      null != a11 && (c4.bindVAO(a11), I2.setUniformMatrix3fv("u_dvsMat3", t11.transforms.displayViewScreenMat3), c4.setStencilFunction(C.EQUAL, t11.stencilRef, 255), c4.drawElements(R.TRIANGLES, e15.outlineIndexCount, O.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * e15.outlineIndexStart), t11.triangleCount += e15.outlineIndexCount / 3);
    }
  }
};
...
var s10 = class extends t9 {
  ...
  drawMany(i6, s11) {
    ...
    if (l7.useProgram(T3), T3.setUniformMatrix3fv("u_displayViewMat3", u8.displayViewMat3), T3.setUniformMatrix3fv("u_displayMat3", U === r3.VIEWPORT ? u8.displayMat3 : u8.displayViewMat3), T3.setUniform2fv("u_lineTranslation", v), T3.setUniform1f("u_depth", M3.z), T3.setUniform1f("u_antialiasing", N4), D2 && null != D2) {
    ...
    for (const e14 of s11) {
      ...
      if (null != u9) {
        if (l7.bindVAO(u9), T3.setUniformMatrix3fv("u_dvsMat3", e14.transforms.displayViewScreenMat3), l7.setStencilFunction(C.EQUAL, e14.stencilRef, 255), x3 || L2) {
          ...
          if (!e15) continue;
          for (const [i8, a10] of e15) {
            const e16 = m3.getPageSize(i8);
            null != e16 && (m3.bind(l7, L.LINEAR, i8, Z), T3.setUniform2fv("u_mosaicSize", e16), T3.setUniform1i("u_texture", Z), l7.drawElements(R.TRIANGLES, a10[1], O.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * a10[0]));
          }
...
var r11 = 1 / Math.LN2;
function u6(n17, t11) {
  return (n17 %= t11) >= 0 ? n17 : n17 + t11;
}
function c2(n17) {
  return u6(n17 * t10, 256);
}
function e13(n17) {
  return Math.log(n17) * r11;
}
...
var d4 = class extends t9 {
  ...
  _drawIcons(e14, t11, o8) {
    ...
    T3 === l2.AUTO && (T3 = t11.getLayoutValue("symbol-placement", c4) === n4.POINT ? l2.VIEWPORT : l2.MAP);
    ...
    for (const i6 of o8) {
      ...
      const a10 = h5.iconVAO;
      if (null != a10) {
        f5.bindVAO(a10), V.setUniformMatrix3fv("u_dvsMat3", i6.transforms.displayViewScreenMat3), V.setUniform1f("u_time", (performance.now() - h5.lastOpacityUpdate) / 1e3);
        for (const [t12, a11] of h5.iconPerPageElementsMap) this._renderIconRange(e14, V, a11, t12, i6);
      }
    }
  }
  _renderIconRange(e14, t11, i6, a10, r12) {
    const { context: n17, spriteMosaic: o8 } = e14;
    this._spritesTextureSize[0] = o8.getWidth(a10) / 4, this._spritesTextureSize[1] = o8.getHeight(a10) / 4, t11.setUniform2fv("u_mosaicSize", this._spritesTextureSize), o8.bind(n17, L.LINEAR, a10, Z), this._setStencilState(e14, r12), n17.drawElements(R.TRIANGLES, i6[1], O.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * i6[0]), r12.triangleCount += i6[1] / 3;
  }
  _drawText(e14, s11, f5) {
    ...
    w === l2.AUTO && (w = s11.getLayoutValue("symbol-placement", u8) === n4.POINT ? l2.VIEWPORT : l2.MAP);
    const L2 = w === l2.MAP, O2 = s11.getLayoutValue("text-keep-upright", u8) && L2, N4 = 0.8 * A2 / d5;
    this._glyphTextureSize || (this._glyphTextureSize = r2(p3.width / 4, p3.height / 4));
    ...
    c4.useProgram(G), G.setUniformMatrix3fv("u_displayViewMat3", w === l2.MAP ? _6.displayViewMat3 : _6.displayMat3), G.setUniformMatrix3fv("u_displayMat3", b3 === r3.VIEWPORT ? _6.displayMat3 : _6.displayViewMat3), G.setUniform2fv("u_textTranslation", z), G.setUniform1f("u_depth", s11.z + g3), G.setUniform2fv("u_mosaicSize", this._glyphTextureSize), G.setUniform1f("u_mapRotation", c2(_6.rotation)), G.setUniform1f("u_keepUpright", O2 ? 1 : 0), G.setUniform1f("u_level", 10 * u8), G.setUniform1i("u_texture", $), G.setUniform1f("u_antialiasingWidth", N4), G.setUniform1f("u_fadeDuration", e5 / 1e3);
    let W = -1;
    for (const t11 of f5) {
      ...
      const a10 = (performance.now() - T3.lastOpacityUpdate) / 1e3;
      G.setUniform1f("u_time", a10), T3.glyphPerPageElementsMap.forEach((e15, i7) => {
        this._renderGlyphRange(c4, e15, i7, p3, G, I2, D2, t11);
      });
    }
  }
  _renderGlyphRange(e14, t11, i6, a10, r12, n17, s11, l7) {
    a10.bind(e14, L.LINEAR, i6, $), n17 && (r12.setUniform1f("u_halo", 1), e14.drawElements(R.TRIANGLES, t11[1], O.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * t11[0]), l7.triangleCount += t11[1] / 3), s11 && (r12.setUniform1f("u_halo", 0), e14.drawElements(R.TRIANGLES, t11[1], O.UNSIGNED_INT, Uint32Array.BYTES_PER_ELEMENT * t11[0]), l7.triangleCount += t11[1] / 3);
  }
  _setStencilState(e14, t11) {
    const { context: i6, is3D: a10, stencilSymbols: r12 } = e14;
    ...
    i6.setStencilWriteMask(0), a10 ? i6.setStencilFunction(C.EQUAL, t11.stencilRef, 255) : i6.setStencilFunction(C.GREATER, 255, 255);
  }
};

// node_modules/@arcgis/core/views/2d/engine/brushes.js
var m2 = { clip: p, stencil: _4, tileDebugInfo: y3, vtlBackground: u5, vtlFill: f4, vtlLine: s10, vtlCircle: n14, vtlSymbol: d4 };
...
var l6 = (e14, r12, t11, o8) => {
  ...
  for (let s11 = 1; s11 < t11; s11++) {
    ...
    n17 += (e14[2 * (r12 + s11)] - t12) * (e14[2 * (r12 + s11) + 1] + o9);
  }
  return o8 ? n17 > 0 : n17 < 0;
};
var u7 = ({ coords: e14, lengths: r12 }, o8) => {
  const n17 = [];
  for (let s11 = 0, i6 = 0; s11 < r12.length; i6 += r12[s11], s11 += 1) {
    const c4 = i6, a10 = [];
    for (; s11 < r12.length - 1 && l6(e14, i6 + r12[s11], r12[s11 + 1], o8); s11 += 1, i6 += r12[s11]) a10.push(i6 + r12[s11] - c4);
    const f5 = e14.slice(2 * c4, 2 * (i6 + r12[s11])), m3 = e2(f5, a10, 2);
    for (const e15 of m3) n17.push(e15 + c4);
  }
  return n17;
};
var y4 = class _y {
  ...
  static fromPath(e14) {
    const r12 = tt(new e(), e14.path, false, false), t11 = r12.coords, o8 = new Uint32Array(u7(r12, true)), n17 = new Uint32Array(t11.length / 2);
    for (let s11 = 0; s11 < n17.length; s11++) n17[s11] = s4(Math.floor(t11[2 * s11]), Math.floor(t11[2 * s11 + 1]));
    return new _y({ geometry: n17 }, o8, R.TRIANGLES);
  }
  static fromGeometry(t11, o8) {
    const n17 = o8.geometry?.type;
    switch (n17) {
      case "polygon":
      ...
      default:
        return i.getLogger("esri.views.2d.engine.webgl.Mesh2D").error(new s("mapview-bad-type", `Unable to create a mesh from type ${n17}`, o8)), _y.fromScreenExtent({ xmin: 0, ymin: 0, xmax: 1, ymax: 1 });
    }
  }
  static fromPolygon(e14, r12) {
    ...
    for (let n17 = 0; n17 < h5.length; n17++) o3(l7, s11[2 * n17], s11[2 * n17 + 1]), e14.toScreen(x3, l7), h5[n17] = s4(Math.floor(x3[0]), Math.floor(x3[1]));
    return new _y({ geometry: h5 }, f5, R.TRIANGLES, true);
  }
  static fromScreenExtent({ xmin: e14, xmax: r12, ymin: t11, ymax: o8 }) {
    const n17 = { geometry: new Uint32Array([s4(e14, t11), s4(r12, t11), s4(e14, o8), s4(e14, o8), s4(r12, t11), s4(r12, o8)]) }, s11 = new Uint32Array([0, 1, 2, 3, 4, 5]);
    return new _y(n17, s11, R.TRIANGLES);
  }
  static fromMapExtent(e14, r12) {
    const [t11, o8] = e14.toScreen([0, 0], [r12.xmin, r12.ymin]), [n17, s11] = e14.toScreen([0, 0], [r12.xmax, r12.ymax]), i6 = { geometry: new Uint32Array([s4(t11, o8), s4(n17, o8), s4(t11, s11), s4(t11, s11), s4(n17, o8), s4(n17, s11)]) }, c4 = new Uint32Array([0, 1, 2, 3, 4, 5]);
...
var c3 = class _c extends e9 {
  ...
  getVAO(e14, t11, r12, s11) {
    const [i6, a10] = t11.size;
    if ("geometry" !== this._clip.type && this._lastWidth === i6 && this._lastHeight === a10 || (this._lastWidth = i6, this._lastHeight = a10, this._destroyGL()), null == this._cache.vao) {
      const i7 = this._createMesh(t11, this._clip), a11 = i7.getIndexBuffer(e14), o8 = i7.getVertexBuffers(e14);
      this._cache.mesh = i7, this._cache.vao = new o4(e14, r12, s11, o8, a11);
    }
  ...
  _createMesh(r12, s11) {
    switch (s11.type) {
      case "rect":
        return y4.fromScreenExtent(n10(s11, r12.size[0], r12.size[1]));
      case "path":
...
//# sourceMappingURL=chunk-GEY3MNEN.js.map
