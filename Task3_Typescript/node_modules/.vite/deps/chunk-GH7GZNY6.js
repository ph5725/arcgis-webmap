...
var p4;
var a7 = new o2({ percentTotal: "percent-of-total", ratio: "ratio", percent: "percent" });
var u3 = new o2({ sizeInfo: "size", colorInfo: "color", transparencyInfo: "opacity", rotationInfo: "rotation" });
...
var m4 = new o2({ classedSize: "class-breaks-size", classedColor: "class-breaks-color", univariateColorSize: "univariate-color-size", relationship: "relationship", predominance: "predominance", dotDensity: "dot-density" });
...
var a9 = new o2({ colorInfo: "color", transparencyInfo: "opacity", rotationInfo: "rotation", sizeInfo: "size" });
...
var z;
var v3 = new o2({ width: "width", depth: "depth", height: "height", widthAndDepth: "width-and-depth", all: "all" });
var w2 = new o2({ unknown: "unknown", inch: "inches", foot: "feet", yard: "yards", mile: "miles", "nautical-mile": "nautical-miles", millimeter: "millimeters", centimeter: "centimeters", decimeter: "decimeters", meter: "meters", kilometer: "kilometers" });
function g4(e4) {
...
r([m({ readOnly: true })], f3.prototype, "cache", null), r([m({ type: v3.apiValues, json: { type: v3.jsonValues, origins: { "web-map": { read: false } }, read: v3.read, write: v3.write } })], f3.prototype, "axis", void 0), r([m()], f3.prototype, "index", null), r([m({ type: String, readOnly: true })], f3.prototype, "inputValueType", null), r([m({ type: p6, json: { write: true } })], f3.prototype, "legendOptions", void 0), r([m({ type: Number, value: null, json: { write: true } })], f3.prototype, "maxDataValue", null), r([m({ type: Number, value: null, json: { write: true } })], f3.prototype, "maxSize", null), r([s3("maxSize")], f3.prototype, "castMaxSize", null), r([o("maxSize")], f3.prototype, "readMaxSize", null), r([m({ type: Number, value: null, json: { write: true } })], f3.prototype, "minDataValue", null), r([m({ type: Number, value: null, json: { write: true } })], f3.prototype, "minSize", null), r([s3("minSize")], f3.prototype, "castMinSize", null), r([o("minSize")], f3.prototype, "readMinSize", null), r([m({ type: String, json: { write: true } })], f3.prototype, "normalizationField", void 0), r([m({ readOnly: true })], f3.prototype, "arcadeRequired", null), r([m({ type: String })], f3.prototype, "scaleBy", void 0), r([m({ type: [l2], value: null, json: { write: true } })], f3.prototype, "stops", null), r([m({ type: ["outline"], json: { write: true } })], f3.prototype, "target", void 0), r([m({ type: String, readOnly: true })], f3.prototype, "transformationType", null), r([m({ type: ["size"], json: { type: ["sizeInfo"] } })], f3.prototype, "type", void 0), r([m({ type: Boolean, json: { write: true, origins: { "web-map": { read: false } } } })], f3.prototype, "useSymbolValue", void 0), r([m({ type: String, json: { write: true } })], f3.prototype, "valueExpression", void 0), r([o("valueExpression", ["valueExpression", "expression"])], f3.prototype, "readValueExpression", null), r([r2("web-scene", "valueExpression")], f3.prototype, "writeValueExpressionWebScene", null), r([m({ type: ["radius", "diameter", "area", "width", "distance"], json: { write: true } })], f3.prototype, "valueRepresentation", void 0), r([m({ type: w2.apiValues, json: { write: w2.write, origins: { "web-map": { read: false }, "web-scene": { write: true }, "portal-item": { write: true } } } })], f3.prototype, "valueUnit", void 0), r([o("valueUnit")], f3.prototype, "readValueUnit", null), f3 = z = r([a2("esri.renderers.visualVariables.SizeVariable")], f3);
...
var u6 = new o2({ colorInfo: "color", transparencyInfo: "opacity", rotationInfo: "rotation", sizeInfo: "size" });
var h3 = /^\[([^\]]+)\]$/i;
...
var v4 = (l4) => {
  ...
  return r([m({ types: [m6], value: null, json: { write: true } })], u7.prototype, "visualVariables", null), r([o("visualVariables", ["visualVariables", "rotationType", "rotationExpression"])], u7.prototype, "readVisualVariables", null), r([r2("visualVariables")], u7.prototype, "writeVisualVariables", null), u7 = r([a2("esri.renderers.mixins.VisualVariablesMixin")], u7), u7;
};
...
//# sourceMappingURL=chunk-GH7GZNY6.js.map
