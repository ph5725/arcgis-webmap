  ...
  _ExecuteIterativeApproach(e, t, s, r, i, m2) {
    ...
    for (; I2.nextPath(); ) for (; I2.hasNextSegment(); ) {
      ...
      for (; ; ) {
        ...
        const h = u + p, x2 = E === i && h >= 20 && Math.abs(h - a2) > 1e-8 * (a2 + h);
        if (m3 + 2 < _ && (x2 || Math.abs(h - a2) > 0 && E > 0)) w2.setLength(p), d2[m3].assign(w2), w2.setValues(s3, b2, u, c2), d2[++m3].assign(w2), x2 ? (E = i, P3[m3] = i) : (E--, P3[m3 - 1] = E, P3[m3] = E);
        else {
          if (z += h, 0 === m3) break;
...
//# sourceMappingURL=chunk-HERLPXJR.js.map
