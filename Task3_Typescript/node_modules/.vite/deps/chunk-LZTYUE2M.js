...
r([r4({ cloudy: "cloudy" }), m({ json: { write: { isRequired: true } } })], p2.prototype, "type", void 0), r([m({ type: Number, nonNullable: true, range: { min: 0, max: 1 }, json: { write: true } })], p2.prototype, "cloudCover", void 0), p2 = c2 = r([a("esri.views.3d.environment.CloudyWeather")], p2);
var i2 = p2;
...
r([r4({ foggy: "foggy" }), m({ json: { write: { isRequired: true } } })], c3.prototype, "type", void 0), r([m({ type: Number, nonNullable: true, range: { min: 0, max: 1 }, json: { write: true } })], c3.prototype, "fogStrength", void 0), c3 = p3 = r([a("esri.views.3d.environment.FoggyWeather")], c3);
var i3 = c3;
...
var x = class {
  constructor() {
    this.startTime = 0, this._data = r3(null), this.coverage = 0, this.absorption = 0, this._readChannels = e6.RG, this.parallax = new O(), this.parallaxNew = new O(), this._anchorPoint = n2(), this._fadeState = r3(A2.HIDE), this._fadeFactor = r3(1);
  }
  get data() {
  ...
  fade(a5, e8, s3) {
    this.isFading && this.fadeFactor < 1 && (this._fadeFactor.value = s3 ? r2((e8 - this.startTime) / (H * s3), 0, 1) : 1, 1 === this.fadeFactor && this._endFade()), this._evaluateState(a5, e8), this._updateParallax(a5);
  }
...
//# sourceMappingURL=chunk-LZTYUE2M.js.map
