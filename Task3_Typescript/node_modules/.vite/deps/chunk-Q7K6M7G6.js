...
function ae(e4, t3, n3, r5, i5) {
  if (e4.length < t3 || e4.length > n3) throw new a2(r5, r.WrongNumberOfParameters, i5);
}
function ue(e4) {
...
function me(e4, t3, r5) {
  ...
  if (e4 === I) {
    ...
    if (ie(t3)) throw new a2(null, r.CannotCompareDateAndTime, null);
    ...
    if (ne(t3)) throw new a2(null, r.CannotCompareDateAndTime, null);
    if (null === t3 || t3 === I) return ce(e4.toNumber(), 0, r5);
    if (n(t3)) return ce(e4.toNumber(), t3, r5);
    if (t(t3)) return ce(e4.toNumber(), Ne(t3), r5);
    if (e2(t3)) return ce(e4.toNumber(), Ne(t3), r5);
    if (ie(t3)) return ce(e4.toNumber(), t3.toNumber(), r5);
    if (re(t3)) throw new a2(null, r.CannotCompareDateAndTime, null);
  }
...
function Ce(e4, t3, n3 = null, r5 = null) {
  ...
  if (null === s4) throw new a2(null, r.FieldNotFound, null, { key: e4 });
...
function Je(e4, t3) {
  if (!(t3 instanceof _)) throw new a2(null, r.InvalidParameter, null);
...
function Me(e4, t3) {
  if (o(e4) || te(e4)) {
    ...
    if (o(e4)) {
      ...
      if (!te(e4)) throw new a2(null, r.InvalidParameter, null);
    ...
    return a(i5) || (i5 = i5.slice().reverse()), new P({ rings: [i5], spatialReference: u, hasZ: n3, hasM: r5 });
  }
  return e4;
}
function Re(e4, t3) {
  if (o(e4) || te(e4)) {
    ...
    return 0 === i5.length ? null : new y({ paths: [i5], spatialReference: o2, hasZ: n3, hasM: r5 });
  }
  return e4;
}
function ve(e4, t3) {
...
function We(e4) {
  ...
  if (!t3.fields) return null;
  const n3 = [];
  for (const r5 of t3.fields) n3.push(y2(r5));
  return { objectIdField: t3.objectIdField, globalIdField: t3.globalIdField ?? "", geometryType: void 0 === P2[t3.geometryType] ? "" : P2[t3.geometryType], fields: n3 };
}
function Qe(r5, i5) {
...
//# sourceMappingURL=chunk-Q7K6M7G6.js.map
