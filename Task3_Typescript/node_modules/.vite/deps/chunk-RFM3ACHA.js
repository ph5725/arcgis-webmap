...
function w3(n15, e6) {
  const t6 = k(e6), o7 = n15.replaceAll(/[\u00B0\u00BA]/g, "^").replaceAll("′", "'").replaceAll("″", '"'), i11 = [];
  return f3.dmsToGeog(t6, 1, [o7], i11) ? new _2(i11[0][0], i11[0][1], e6 || f4.WGS84) : null;
}
function g3(n15) {
...
var a4 = class extends O {
  ...
  render() {
    return n2("div", { class: this.classes({ [d5.base]: true, [d5.inputMode]: "input" === this.mode }) }, n2("div", { class: d5.title, key: "title" }, this.title), n2("div", { class: d5.value, key: "value" }, this.value));
  }
};
...
function g4(t6, a6, n15, i11 = 2, u2 = "abbr") {
  return g2(t6, s4(a6, n15).value, n15, i11, u2);
}
function L2(t6, e6, a6, n15 = 2, i11 = "abbr") {
  return p3(t6, s4(e6, a6).value, a6, n15, i11);
}
function d6(t6, r5, e6 = 2, n15 = "abbr") {
  return D(t6, r5.value, r5.unit, e6, n15);
}
...
function U3(r5, e6, a6, n15 = a2, u2 = true) {
  return w2(r5.value, r5.unit, r5.rotationType, e6, a6, n15, u2);
}
...
var S4 = class extends O {
  ...
  render() {
    ...
    return n2("div", { class: v(t5, r5 && n5), onkeydown: this._onKeyDown, tabIndex: -1 }, r5 && n15 && t6.header ? n2("div", { class: _5, "data-testid": "tooltip-header", key: "header", onpointerdown: this._onHeaderPointerDown }, n2("calcite-button", { appearance: "transparent", "data-testid": "tooltip-back-button", iconFlipRtl: "both", iconStart: "chevron-left", key: "discard-button", kind: "neutral", onclick: this._onDiscard, scale: "s", tabIndex: -1 }), o7.length > 0 ? n2(i, null, n2("div", { class: a3, key: "spacer" }), n2("div", { class: o6, key: "actions" }, o7)) : null) : null, i11 ? n2("div", { class: c3, key: "content" }, ...e6) : null, s9);
  }
  destroy() {
  ...
  loadDependencies() {
    return c({ button: () => import("./calcite-button-YXGWMUBG.js"), icon: () => import("./calcite-icon-5R57LYRD.js"), input: () => import("./calcite-input-H3JK4BG3.js") });
  }
  ...
  get _renderedHelpMessage() {
    ...
    return n2("div", { class: $2, key: "help-message" }, s9 ? n2("calcite-icon", { class: h3, icon: s9, scale: "s" }) : null, n2("div", { class: r3 }, o7));
  }
...
var n6 = class extends S4 {
  _renderContent() {
    ...
    return n2(i, null, a6.radius && null != e6 ? n2(a4, { title: p8.radius, value: m4.length(e6) }) : null, a6.size && null != s9 && null != n15 ? n2(a4, { title: p8.size, value: n2(a5, { left: m4.length(s9), right: m4.length(n15) }) }) : null, a6.area ? n2(a4, { title: p8.area, value: m4.area(t6) }) : null);
  }
};
...
var _6 = class extends O {
  ...
  loadDependencies() {
    return c({ button: () => import("./calcite-button-YXGWMUBG.js"), icon: () => import("./calcite-icon-5R57LYRD.js"), input: () => import("./calcite-input-H3JK4BG3.js"), "input-message": () => import("./calcite-input-message-PZNDRGFX.js") });
  }
  render() {
    const { field: t6, mode: e6 } = this, i11 = "input" === e6, { locked: o7, readOnly: n15 } = t6;
    return n2("div", { class: this.classes({ [d7.base]: true, [d7.feedbackMode]: "feedback" === e6, [d7.inputMode]: "input" === e6, [d7.locked]: o7, [d7.readOnly]: n15 }) }, n2("div", { class: d7.title, key: "title" }, this._title), n2("div", { class: d7.value, key: "value", onkeydown: this._onKeyDown }, i11 ? this._renderValueInputMode() : this._renderValueFeedbackMode()));
  }
  get _formattedValue() {
...
function i5(i11) {
  ...
  return 0 === l4.length ? null : n2(i, null, l4.map((e6) => n2(_6, { context: i11.context, field: e6, key: e6.id, mode: i11.mode })));
}
...
var s6 = class extends S4 {
  _renderContent() {
    ...
    return n2(i5, { context: o7, fields: [s9.coordinates ? t6.effectiveX : void 0, s9.coordinates ? t6.effectiveY : void 0, s9.elevation ? t6.elevation : void 0, s9.orientation ? t6.orientation : void 0, s9.scale ? t6.scale : void 0], mode: i11 });
  }
};
...
var i6 = class extends S4 {
  _renderContent() {
    ...
    return n2(i5, { context: o7, fields: [n15.coordinates ? t6.effectiveX : void 0, n15.coordinates ? t6.effectiveY : void 0, n15.elevation ? i11 : void 0], mode: r5 });
  }
};
...
var p7 = class extends O {
  ...
  render() {
    return n2("div", { class: s5 }, this._isElementVisible("direction") ? n2(l3, { messages: this.messages, sketchOptions: this.sketchOptions }) : null);
  }
  loadDependencies() {
    return c({ button: () => import("./calcite-button-YXGWMUBG.js"), dropdown: () => import("./calcite-dropdown-J6ZQ2DYA.js"), "dropdown-item": () => import("./calcite-dropdown-item-EPOXCLC4.js"), "dropdown-group": () => import("./calcite-dropdown-group-BS2G5UP7.js") });
  }
...
function l3(e6) {
  ...
  return n2("calcite-dropdown", { key: "direction-mode", placement: "bottom-end", scale: "s", widthScale: "s", onCalciteDropdownSelect: (t7) => {
    const o8 = t7.currentTarget.selectedItems?.[0]?.getAttribute("data-mode");
    e6.sketchOptions.values.directionMode = o8 ?? "absolute";
  } }, n2("calcite-button", { alignment: "end", appearance: "transparent", iconStart: e5[t6], kind: "neutral", label: s9, scale: "s", slot: "trigger", title: s9 }), n2("calcite-dropdown-group", { selectionMode: "single" }, n2("calcite-dropdown-item", { "data-mode": c4, "data-testid": "tooltip-direction-mode-relative", iconStart: e5.relative, key: "relative", selected: t6 === c4 }, o7?.directionModeSelect?.relative), n2("calcite-dropdown-item", { "data-mode": r5, "data-testid": "tooltip-direction-mode-absolute", iconStart: e5.absolute, key: "absolute", selected: t6 === r5 }, o7?.directionModeSelect?.absolute)));
}
...
var n7 = class extends S4 {
  _renderContent() {
    ...
    return n2(i5, { context: o7, fields: [..."direction-distance" === r5 ? [n15.direction ? e6.direction : void 0, n15.distance ? e6.distance : void 0] : [n15.coordinates ? e6.effectiveX : void 0, n15.coordinates ? e6.effectiveY : void 0], n15.elevation ? e6.elevation : void 0, n15.area ? e6.area : void 0], mode: t6 });
  }
  _renderActions() {
    const { xyMode: o7, sketchOptions: e6 } = this.info;
    return n2(p7, { sketchOptions: e6, visibleElements: { direction: "direction-distance" === o7 } });
  }
};
...
var n8 = class extends S4 {
  _renderContent() {
    ...
    return n2(i5, { context: o7, fields: [..."direction-distance" === s9 ? [n15.direction ? t6.direction : void 0, n15.distance ? t6.distance : void 0] : [n15.coordinates ? t6.effectiveX : void 0, n15.coordinates ? t6.effectiveY : void 0], n15.elevation ? t6.elevation : void 0, n15.totalLength ? t6.totalLength : void 0], mode: e6 });
  }
  _renderActions() {
    const { xyMode: o7, sketchOptions: t6 } = this.info;
    return n2(p7, { sketchOptions: t6, visibleElements: { direction: "direction-distance" === o7 } });
  }
};
...
var n9 = class extends S4 {
  _renderContent() {
    ...
    return n2(i, null, n15.size && null != e6 && null != s9 ? n2(a4, { title: a6.size, value: n2(a5, { left: p8.length(e6), right: p8.length(s9) }) }) : null, n15.area ? n2(a4, { title: a6.area, value: p8.area(t6) }) : null);
  }
};
...
var n10 = class extends S4 {
  _renderContent() {
    ...
    return n2(i, null, o7.rotation ? n2(a4, { title: s9.rotation, value: this._formatters.angleRelative(t6) }) : null);
  }
};
...
var n11 = class extends S4 {
  _renderContent() {
    ...
    return n2(i, null, e6.size ? n2(a4, { title: r5.size, value: n2(a5, { left: n15.length(t6.xSize), right: n15.length(t6.ySize) }) }) : null, e6.scale ? n2(a4, { title: r5.scale, value: n2(a5, { left: n15.scale(t6.xScale), right: n15.scale(t6.yScale) }) }) : null);
  }
};
...
var i7 = class extends S4 {
  _renderContent() {
    ...
    return n2(i5, { context: o7, fields: [i11.coordinates ? t6.effectiveX : void 0, i11.coordinates ? t6.effectiveY : void 0, i11.elevation ? t6.elevation : void 0], mode: r5 });
  }
};
...
var i8 = class extends S4 {
  _renderContent() {
    ...
    return n2(i5, { context: t6, fields: [i11.distance ? o7.distance : void 0, i11.area ? o7.area : void 0, i11.totalLength ? o7.totalLength : void 0], mode: s9 });
  }
};
...
var i9 = class extends S4 {
  _renderContent() {
    ...
    return n2(i5, { context: e6, fields: [i11.coordinates ? o7.effectiveX : void 0, i11.coordinates ? o7.effectiveY : void 0, i11.elevation ? o7.elevation : void 0, i11.area && "polygon" === o7.geometryType ? o7.area : null, i11.totalLength && "polyline" === o7.geometryType ? o7.totalLength : null], mode: r5 });
  }
};
...
var s8 = class extends S4 {
  _renderContent() {
    const { fieldContext: o7, info: t6, mode: i11 } = this, { visibleElements: s9 } = t6;
    return n2(i5, { context: o7, fields: [s9.coordinates ? t6.effectiveX : void 0, s9.coordinates ? t6.effectiveY : void 0, s9.elevation ? t6.elevation : void 0, s9.orientation ? t6.orientation : void 0, s9.size ? t6.size : void 0], mode: i11 });
  }
};
...
var n12 = class extends S4 {
  _renderContent() {
    ...
    return n2(i, null, o7.distance ? n2(a4, { title: e6.distance, value: n15.length(t6.distance) }) : null);
  }
};
...
var i10 = class extends S4 {
  _renderContent() {
    ...
    return n2(i, null, n15.distance ? n2(a4, { title: a6.distance, value: c4.length(t6) }) : null, n15.elevation && null != e6?.actual ? n2(a4, { title: a6.elevation, value: c4.verticalLength(e6.actual) }) : null, n15.area && null != l4 ? n2(a4, { title: a6.area, value: c4.area(l4) }) : null, n15.totalLength && null != i11 ? n2(a4, { title: a6.totalLength, value: c4.length(i11) }) : null);
  }
};
...
var n14 = class extends S4 {
  _renderContent() {
    ...
    return n2(i, null, o7.distance ? n2(a4, { title: e6.distance, value: this._formatters.verticalLengthRelative(t6.distance) }) : null);
  }
};
...
function j4(j6, d8) {
  ...
  switch (d8.type) {
    ...
    case "draw-multipoint":
      return new i6({ tooltip: j6, info: d8, container: x4 });
    case "draw-polygon":
      return new n7({ tooltip: j6, info: d8, container: x4 });
    case "draw-polyline":
      return new n8({ tooltip: j6, info: d8, container: x4 });
    case "draw-mesh":
      return new s6({ tooltip: j6, info: d8, container: x4 });
    case "draw-rectangle":
      return new n9({ tooltip: j6, info: d8, container: x4 });
    case "draw-circle":
      return new n6({ tooltip: j6, info: d8, container: x4 });
    case "extent-rotate":
      return new n10({ tooltip: j6, info: d8, container: x4 });
    case "extent-scale":
      return new n11({ tooltip: j6, info: d8, container: x4 });
    case "move-point":
      return new i7({ tooltip: j6, info: d8, container: x4 });
    case "selected-vertex":
      return new i9({ tooltip: j6, info: d8, container: x4 });
    case "transform-point":
      return new s8({ tooltip: j6, info: d8, container: x4 });
    case "transform-mesh":
      return new s7({ tooltip: j6, info: d8, container: x4 });
    case "translate":
      return new n12({ tooltip: j6, info: d8, container: x4 });
    case "translate-vertex":
      return new i10({ tooltip: j6, info: d8, container: x4 });
    case "translate-z":
      return new n14({ tooltip: j6, info: d8, container: x4 });
    case "translate-xy":
      return new n13({ tooltip: j6, info: d8, container: x4 });
    case "reshape-edge-offset":
      return new i8({ tooltip: j6, info: d8, container: x4 });
  }
}
...
//# sourceMappingURL=chunk-RFM3ACHA.js.map
