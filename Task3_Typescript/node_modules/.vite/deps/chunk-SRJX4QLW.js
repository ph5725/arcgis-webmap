...
r([m({ type: l2, json: { write: true } })], g.prototype, "backgroundColor", void 0), r([m({ type: l2, json: { write: true } })], g.prototype, "borderLineColor", void 0), r([m({ type: Number, json: { write: true }, cast: o })], g.prototype, "borderLineSize", void 0), r([m({ type: l4, json: { write: true } })], g.prototype, "font", void 0), r([m({ ...m2, json: { write: true } })], g.prototype, "horizontalAlignment", void 0), r([m({ type: Boolean, json: { write: true } })], g.prototype, "kerning", void 0), r([m({ type: l2, json: { write: true } })], g.prototype, "haloColor", void 0), r([m({ type: Number, cast: o, json: { write: true } })], g.prototype, "haloSize", void 0), r([m({ type: Boolean, json: { write: true } })], g.prototype, "rightToLeft", void 0), r([m({ type: Boolean, json: { write: true } })], g.prototype, "rotated", void 0), r([m({ type: String, json: { write: true } })], g.prototype, "text", void 0), r([r4({ esriTS: "text" }, { readOnly: true })], g.prototype, "type", void 0), r([m({ ...p, json: { write: true } })], g.prototype, "verticalAlignment", void 0), r([m({ type: Number, cast: o, json: { write: true } })], g.prototype, "xoffset", void 0), r([m({ type: Number, cast: o, json: { write: true } })], g.prototype, "yoffset", void 0), r([m({ type: Number, json: { read: (t2) => t2 && -1 * t2, write: (t2, o2) => o2.angle = t2 && -1 * t2 } })], g.prototype, "angle", void 0), r([m({ type: Number, json: { write: true } })], g.prototype, "width", void 0), r([m({ type: Number })], g.prototype, "lineWidth", void 0), r([r3("lineWidth")], g.prototype, "writeLineWidth", null), r([s("lineWidth")], g.prototype, "castLineWidth", null), r([m(n)], g.prototype, "lineHeight", void 0), r([r3("lineHeight")], g.prototype, "writeLineHeight", null), g = f = r([a3("esri.symbols.TextSymbol")], g);
...
//# sourceMappingURL=chunk-SRJX4QLW.js.map
