...
import "./chunk-RFM3ACHA.js";
import {
  S,
  s as s5
} from "./chunk-SP5E3FR4.js";
import "./chunk-6VC2SGU3.js";
import "./chunk-R4OUYMNP.js";
...
var l4 = new u2({ style: "circle", size: 6, color: [127, 127, 127, 1], outline: { color: [50, 50, 50], width: 1 } });
var i = new u2({ style: "circle", size: 6, color: [255, 127, 0, 1], outline: { color: [50, 50, 50], width: 1 } });
...
var w2 = class extends r5 {
  constructor(i2) {
    super(), this._handles = new r2(), this._planeStart = W(), this._displayPlaneStart = W(), this._originCache = n(), this._axisCache = n3(), this._renderStartCache = n(), this._renderEndCache = n(), this._resizeOriginCache = n(), this._view = i2.view, this._tool = i2.tool, this._graphic = i2.graphic, this._direction = i2.direction, this._preserveAspectRatio = i2.preserveAspectRatio, this._manipulator = this._createManipulator(), this._handles.add([this._manipulator.events.on("grab-changed", (t4) => n6(t4, this._manipulator))]), this.forEachManipulator((t4) => this._tool.manipulators.add(t4));
  }
  destroy() {
    this._handles.destroy(), this.forEachManipulator((t4) => {
      this._tool.manipulators.remove(t4), t4.destroy();
...
var Y = class extends n5 {
  ...
  get _plane() {
    ...
    return s2(a2, e4.spatialReference) && (o2 *= Z(a2) / Z(e4.spatialReference)), S2(s8, t4, o2, this._planeCache);
  }
  get _displayPlane() {
  ...
  get _rotateGraphicGeometry() {
    ...
    return A(t4, e4.basis1), g(t4, t4, J * this.view.resolution), u3(t4, t4, e4.origin), u3(t4, t4, e4.basis1), new _({ x: t4[0], y: t4[1], spatialReference: this.view.spatialReference });
  }
...
//# sourceMappingURL=editingTools-HYAJJMTG.js.map
