...
exports.removeItemThumbnail = exports.removeFolder = exports.removeItemResource = exports.removeItemRelationship = exports.removeItem = void 0;
...
function removeItemThumbnail(requestOptions) {
    return (0, helpers_js_1.determineOwner)(requestOptions).then((owner) => {
        const url = `${(0, get_portal_url_js_1.getPortalUrl)(requestOptions)}/content/users/${owner}/items/${requestOptions.id}/deleteThumbnail`;
        return (0, arcgis_rest_request_1.request)(url, requestOptions);
    });
}
exports.removeItemThumbnail = removeItemThumbnail;
