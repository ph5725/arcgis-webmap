...
const determine_username_js_1 = require("../util/determine-username.js");
/**
...
async function getUserTags(requestOptions) {
    const username = await (0, determine_username_js_1.determineUsername)(requestOptions);
    const url = `${(0, get_portal_url_js_1.getPortalUrl)(requestOptions)}/community/users/${username}/tags`;
    // send the request
