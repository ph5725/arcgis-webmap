 ...
 */
export async function getUserInvitations(requestOptions) {
 ...
 */
export async function getUserInvitation(requestOptions) {
    const username = await determineUsername(requestOptions);
    const portalUrl = getPortalUrl(requestOptions);
 ...
 */
export async function acceptInvitation(requestOptions) {
    const username = await determineUsername(requestOptions);
    const portalUrl = getPortalUrl(requestOptions);
 ...
 * @returns A Promise that will resolve with the success/failure status of the request
 */
export async function declineInvitation(requestOptions) {
    const username = await determineUsername(requestOptions);
    const portalUrl = getPortalUrl(requestOptions);
